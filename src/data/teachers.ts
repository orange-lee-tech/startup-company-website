...
export const teachers: Teacher[] = [
  ...
  },
  {
    id: "han-yuhong",
    name: "韩老师",
    school: "高考升学规划方向｜九辰教育",
    title: "首席高考升学规划导师",
    gender: "male",
    portraitImage: getPortrait("male"),
    featured: true,
    hasDetail: false,
    summary: "国家一级生涯规划师，侧重高考升学规划与志愿填报咨询。",
  },
  {
    id: "zhao-qinghai",
    name: "赵老师",
    school: "升学规划与心理咨询方向｜九辰教育",
    title: "专家团队首席升学规划导师",
    gender: "male",
    portraitImage: getPortrait("male"),
    featured: true,
    hasDetail: false,
    summary: "心理咨询与生涯规划背景导师，侧重升学规划与学生发展支持。",
  },
  {
    id: "chen-xin",
    name: "陈老师",
    school: "升学规划后期服务方向｜九辰教育",
    title: "首席升学规划后期服务导师",
    gender: "female",
    portraitImage: getPortrait("female"),
    featured: true,
    hasDetail: false,
    summary: "侧重综评、强基、港澳及英美加等升学规划后期服务。",
  },
  {
    id: "ou-xiangmei",
    name: "欧老师",
    school: "升学规划与志愿填报方向｜九辰教育",
    title: "专家团队首席升学规划导师",
    gender: "female",
    portraitImage: getPortrait("female"),
    featured: true,
    hasDetail: false,
    summary: "心理咨询与志愿填报背景导师，侧重升学规划与志愿咨询。",
  },
  {
    id: "li-qian",
    name: "李老师",
