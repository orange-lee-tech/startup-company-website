...
const Contact = () => {
  return (
    <section
  id="contact"
  className="overflow-hidden bg-primary/95 py-16 md:py-20 lg:py-28"
>
          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              ...
              <p className="mb-12 text-base font-medium text-body-color">
                留下你的基本信息与意向服务，九辰规划老师将在 24 小时内联系你，提供免费 1 对 1 初步评估。
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="w-full px-4">
                    <div className="mb-8">
                      ...
                      <textarea
                        name="message"
                        rows={5}
                        placeholder="例如：本科在读，想咨询保研；硕士在读，想咨询国内申博；应届生，想咨询就业陪跑。"
