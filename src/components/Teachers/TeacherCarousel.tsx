        ...
        <div className="grid grid-cols-1 overflow-hidden rounded-2xl border border-body-color/10 bg-white dark:border-white/10 dark:bg-gray-dark md:grid-cols-3">
          {visibleTeachers.map((teacher) => (
            <Link
              key={teacher.id}
              href="/teachers"
              className="group relative min-h-[380px] overflow-hidden border-b border-body-color/10 bg-white transition hover:z-10 hover:shadow-three dark:border-white/10 dark:bg-gray-dark md:border-b-0 md:border-r md:last:border-r-0"
            >
              <div className="relative h-[235px] w-full overflow-hidden bg-[#EEF3FF] dark:bg-bg-color-dark">
                <Image
